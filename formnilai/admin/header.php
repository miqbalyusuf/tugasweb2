	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav navbar-left">
			...
			<li<?php if ($thisPage=="Tambah") echo " class=\"active\""; ?>><a href="tambah.php" data-toggle="tooltip" data-placement="bottom" title="Tambah Data Mahasiswa" ><span class="glyphicon glyphicon-user"></span> Tambah Data</a></li>
